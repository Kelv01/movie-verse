...
function MovieCard({ movie, onClick }) {
  const prefetchMovieDetails = useMovieStore(
    (state) => state.prefetchMovieDetails
  );
  ...
  return (
    <div
      ...
      className="bg-yinminblue h-full rounded-lg overflow-hidden hover:scale-105 transition-transform duration-200 hover:border hover:border-xanthous cursor-pointer"
    >
      <img
